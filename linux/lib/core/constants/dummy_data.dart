...
class DummyData {
  static const List<Map<String, dynamic>> carouselSlides = [
    {
      'id': 1,
      'title': 'خصم 30% على الفحوصات الشاملة',
      'subtitle': 'احجز الآن واستفد من العرض',
      'image_url': 'https://picsum.photos/800/400?random=1',
      'link': null,
    },
    {
      'id': 2,
      'title': 'فحص PCR بأسعار مخفضة',
      'subtitle': 'نتائج سريعة خلال 24 ساعة',
      'image_url': 'https://picsum.photos/800/400?random=2',
      'link': null,
    },
    {
      'id': 3,
      'title': 'خدمة الفحص المنزلي متوفرة',
      'subtitle': 'اطلب الفني إلى منزلك',
  ...
  static const List<Map<String, dynamic>> labs = [
    {
      'id': 1,
      'business_name_ar': 'مختبر الفاروق',
      'business_name_en': 'Al-Farooq Lab',
      'city': 'الرياض',
      'district': 'النخيل',
      'logo_url': 'https://picsum.photos/100/100?random=l1',
      'avg_rating': 4,
      'total_reviews': 128,
    ...
    {
      'id': 2,
      'business_name_ar': 'مختبر الصحة',
      'business_name_en': 'Health Lab',
      'city': 'جدة',
      'district': 'الحمراء',
      'logo_url': 'https://picsum.photos/100/100?random=l2',
      'avg_rating': 5,
      'total_reviews': 256,
      'home_service_available': true,
    },
    {
      'id': 3,
      'business_name_ar': 'مختبر المعرفة',
      'business_name_en': 'Knowledge Lab',
      'city': 'الرياض',
      'district': 'الياسمين',
      'logo_url': 'https://picsum.photos/100/100?random=l3',
      'avg_rating': 4,
      'total_reviews': 89,
    ...
    {
      'id': 4,
      'business_name_ar': 'مختبر النخبة',
      'business_name_en': 'Elite Lab',
      'city': 'الدمام',
      'district': 'الفيصلية',
      'logo_url': 'https://picsum.photos/100/100?random=l4',
      'avg_rating': 5,
      'total_reviews': 312,
      'home_service_available': true,
    },
