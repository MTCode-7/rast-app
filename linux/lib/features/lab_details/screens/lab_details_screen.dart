        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 24),
              FilledButton.icon(onPressed: _loadData, icon: const Icon(Icons.refresh_rounded, size: 20), label: const Text('إعادة المحاولة'), style: FilledButton.styleFrom(backgroundColor: AppTheme.primary, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(18)))),
            ],
          ),
        ),
      );
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.medical_services_rounded, color: AppTheme.primary, size: 22),
                ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 4),
                      Text(homePrice != null ? '$price ر.س في المختبر • $homePrice ر.س منزلي' : '$price ر.س', style: TextStyle(fontSize: Responsive.fontSize(context, 12), color: AppTheme.onSurfaceVariant)),
                    ],
                  ),
                ),
