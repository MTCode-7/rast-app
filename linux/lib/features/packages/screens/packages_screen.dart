...
class _PackageCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final price = (package['price'] is num ? package['price'] as num : 0).toDouble();
    final originalPrice = package['original_price'] is num ? (package['original_price'] as num).toDouble() : null;
    final imageUrl = ApiConfig.resolveImageUrl(package['image_url'], package['image']);
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text('$price ر.س', style: TextStyle(fontSize: Responsive.fontSize(context, 12), color: Colors.white, fontWeight: FontWeight.w600)),
                          ),
                          if (originalPrice != null) Text('$originalPrice ر.س', style: TextStyle(fontSize: Responsive.fontSize(context, 11), color: AppTheme.onSurfaceVariant, decoration: TextDecoration.lineThrough)),
                        ],
                      ),
