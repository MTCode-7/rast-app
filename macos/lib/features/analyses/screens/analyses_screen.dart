...
class _AnalysesScreenState extends State<AnalysesScreen> {
  ...
  String? _getServiceImageUrl(Map<String, dynamic> service, [Map<String, dynamic>? providerService]) {
                            ...
                            : RefreshIndicator(
                                ...
                                child: GridView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    final providerSvc = widget.labId != null && item is Map ? item as Map<String, dynamic> : null;
                                    return _AnalysisCard(
                                      service: service,
                                      categoryName: _getCategoryName(context, service['category_id'] ?? service['service_category_id']),
                                      imageUrl: _getServiceImageUrl(service, providerSvc),
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text(
                              price > 0 ? '${price.toStringAsFixed(2)} ر.س' : '— ر.س',
