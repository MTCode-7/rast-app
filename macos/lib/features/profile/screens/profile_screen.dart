...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget _buildGuestAvatar() {
    return Container(
      ...
      child: Icon(Icons.person_outline_rounded, size: 56, color: Colors.white.withValues(alpha: 0.95)),
    );
  }
          ...
          SizedBox(
            ...
            child: OutlinedButton(
              ...
              style: OutlinedButton.styleFrom(
                side: BorderSide(color: AppTheme.primary.withValues(alpha: 0.7), width: 1.5),
        ...
        children: [
          CircleAvatar(
            ...
            child: Text(
              ...
              style: TextStyle(fontSize: 32, fontWeight: FontWeight.w700, color: AppTheme.primary),
            ),
          ),
          SizedBox(height: Responsive.spacing(context, 16)),
          Text(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(20),
            boxShadow: [
              BoxShadow(color: Colors.black.withValues(alpha: theme.brightness == Brightness.dark ? 0.16 : 0.03), blurRadius: 10, offset: const Offset(0, 3)),
            ],
          ),
          child: Row(
            children: [
